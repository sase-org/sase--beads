...
|---|---|---|---|---:|---:|
| [sase-4e.1](sase-4e.1.md) | Phase 1: Shared Guardrails And Branch Hygiene | ✓ closed | small | 1 | 2 |
...
| [sase-4e.5](sase-4e.5.md) | Phase 5: Add release-plz To sase-core | ✓ closed | small | 1 | 1 |
