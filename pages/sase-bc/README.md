...
| [sase-bc.3](sase-bc.3.md) | Commit/artifact event capture, detached runner, notifications | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n3["sase-bc.3: Commit/artifact event capture, detached runner, notifications [in_progress]"]
