...
|---|---|---|---|---:|---:|
| [sase-bf.1](sase-bf.1.md) | Canonical structured value model, storage, and renderers | ◐ in_progress | medium | 1 | 0 |
| [sase-bf.2](sase-bf.2.md) | Full JSON output-variable values in the sase-core scan wire | ✓ closed | medium | 1 | 1 |
...
flowchart TD
    ...
    n1["sase-bf.1: Canonical structured value model, storage, and renderers [in_progress]"]
...
| Agent | Bead | Commits |
|---|---|---:|
| [bbugyi200.athena.sase-bf.1](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-bf.1/README.md) | [sase-bf.1](sase-bf.1.md) | 0 |
