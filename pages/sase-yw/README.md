...
flowchart TD
    ...
    n5["sase-yw.3.2: Complete ACE and Neovim integration proof [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n3 --> n4
...
| [bbugyi200.athena.sase-yw.3.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-yw.3.2/README.md) | [sase-yw.3.2](sase-yw.3.2.md) | 0 |
