# Bead: sase-tj.4 — Feature flag, pane contract, and the mounted list
...
pane: create the disabled beta flag, register the built-in adapter/descriptor before Files, and mount a snapshot-backed list that renders the shared shell and passes contract conformance in both flag states.
