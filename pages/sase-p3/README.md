...
flowchart TD
    ...
    n7["sase-p3.2: Task-type spec validation, digest, and body rendering in Rust [in_progress]"]
    n8["sase-p3.3: Required plugin prefix for every `use:` field [in_progress]"]
