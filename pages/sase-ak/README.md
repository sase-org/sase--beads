...
|---|---|---|---|---:|---:|
| [sase-ak.1](sase-ak.1.md) | Reject reserved tribe references in wait and fork targets | ✓ closed | small | 1 | 0 |
| [sase-ak.2](sase-ak.2.md) | Shared tribe wait binding resolver | ✓ closed | medium | 1 | 0 |
| [sase-ak.3](sase-ak.3.md) | Tribe-aware wait rendering in the Agents tab | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n3["sase-ak.3: Tribe-aware wait rendering in the Agents tab [in_progress]"]
...
| Agent | Bead | Commits |
|---|---|---:|
| [bbugyi200.athena.sase-ak.1](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ak.1/README.md) | [sase-ak.1](sase-ak.1.md) | 0 |
