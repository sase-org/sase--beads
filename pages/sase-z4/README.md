...
flowchart TD
    ...
    n21["sase-z4.6.5.4.6: Finish weighted-capacity lifecycle and published-package proof [closed]"]
    ...
    n24["sase-z4.6.5.4.6.3: Establish and verify the published minimum-version cohort [closed]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
