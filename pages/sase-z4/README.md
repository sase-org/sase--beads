...
flowchart TD
    ...
    n8["sase-z4.6.2: Make weighted continuation and shell admission atomic [in_progress]"]
...
| [bbugyi200.athena.sase-z4.6.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-z4.6.2/README.md) | [sase-z4.6.2](sase-z4.6.2.md) | 0 |
