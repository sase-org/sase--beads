...
|---|---|---|---|---:|---:|
| [sase-eb.1](sase-eb.1.md) | Shared xprompt highlight core (roles, flattened spans, palette) | ◐ in_progress | medium | 1 | 0 |
| [sase-eb.2](sase-eb.2.md) | Definition resolution, provenance, and the JSON record | ✓ closed | medium | 1 | 1 |
| [sase-eb.3](sase-eb.3.md) | Rich rendering of the show layout | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-eb.1: Shared xprompt highlight core (roles, flattened spans, palette) [in_progress]"]
    n2["sase-eb.2: Definition resolution, provenance, and the JSON record [closed]"]
    n3["sase-eb.3: Rich rendering of the show layout [in_progress]"]
...
| [bbugyi200.athena.sase-eb.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-eb.3/README.md) | [sase-eb.3](sase-eb.3.md) | 0 |
