...
| [sase-vd.2](sase-vd.2.md) | Pre-allocation survives shell follow-up launches | ◐ in_progress | medium | 2026-08-28 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-vd.2: Pre-allocation survives shell follow-up launches [in_progress]"]
