# Bead: sase-zn.9.5 — Prove sustained responsiveness on the integrated tree
...
sustained_acceptance: capture a multi-day RSS series and current latency, CPU, watchdog, and scratch evidence under real load, then verify the combined source and binding cohort.
