...
| [sase-ku.6](sase-ku.6.md) | --idle-timeout for commands that hang without exiting | ◐ in_progress | small | 2026-08-13 | 1 | 0 |
...
flowchart TD
    ...
    n7["sase-ku.6: --idle-timeout for commands that hang without exiting [in_progress]"]
