...
|---|---|---|---|---:|---:|
| [sase-dz.1](sase-dz.1.md) | Raise the published sase-core-rs floor to 0.17.8 | ◐ in_progress | small | 1 | 0 |
...
| [sase-dz.4](sase-dz.4.md) | Skip the prompt-archive check when its context is unavailable | ◐ in_progress | medium | 1 | 0 |
| [sase-dz.5](sase-dz.5.md) | Publish the plans-sidecar prompt migration | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-dz.1: Raise the published sase-core-rs floor to 0.17.8 [in_progress]"]
    ...
    n4["sase-dz.4: Skip the prompt-archive check when its context is unavailable [in_progress]"]
    n5["sase-dz.5: Publish the plans-sidecar prompt migration [in_progress]"]
...
| Agent | Bead | Commits |
|---|---|---:|
| [bbugyi200.athena.sase-dz.1](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-dz.1/README.md) | [sase-dz.1](sase-dz.1.md) | 0 |
