...
| --- | --- | --- | ---: |
| read-by | [agent:sase-16n.11.7.3][1] | Need the phase scope and design file | 1 |
| read-by | [agent:sase-16y.land][2] | child scope for red-test triage | 1 |

[1]: https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-16n.11.7.3/README.md
