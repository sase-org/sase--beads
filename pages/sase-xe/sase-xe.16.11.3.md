...
**Owner:** `bryanbugyi34@gmail.com` · **Created by:** `bbugyi200.athena.sase-xe.16.land--1` · **Assignee:** `sase-xe.16.11.3` · **Size:** medium
**Created:** 2026-09-09 04:38:28 EDT
...
> ↺ Closed 2026-09-09T13:18:26Z · done
>
> (none)
>
> Reopened 2026-09-09T16:11:57Z by `sase bead open`
...
[2026-09-09T16:13:13Z · sase-xe.16.11.land] LAND AUDIT: Reopened because the required successful healthy-host result beside an actual hung host is not proved. In core a6d40ba (still present at 3baa689), worker_bounds_deadline_and_preserves_fast_host_beside_hung_host uses a closed port and explicitly asserts the fast host status is not ok. This proves fast failure preservation, not the required usable healthy host. RemoteHost::new ignores validated plan.tls, confirming proposal #1; absorb TLS correctness and an authenticated successful HTTPS gateway fixture into remaining epic work. Preserve the existing real bootstrap, stale-revision/instance enforcement and fault-overlap coverage; the replacement-instance test must also capture an old locator, replace the real fixture instance, then reject that captured locator (the current test fabricates other-run). A child plan will supply the missing proof before this phase can close normally.
