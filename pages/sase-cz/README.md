...
| [sase-cz.2](sase-cz.2.md) | Task triage gate identity, filer, and self-heal | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-cz.2: Task triage gate identity, filer, and self-heal [in_progress]"]
...
| [bbugyi200.athena.sase-cz.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-cz.2/README.md) | [sase-cz.2](sase-cz.2.md) | 0 |
