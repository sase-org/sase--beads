...
| [sase-zu.3](sase-zu.3.md) | Artifact index gains full-history candidate filtering and machine provenance | ◐ in_progress | medium | 2026-09-12 | 1 | 0 |
...
flowchart TD
    ...
    n3["sase-zu.3: Artifact index gains full-history candidate filtering and machine provenance [in_progress]"]
...
| [bbugyi200.athena.sase-zu.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-zu.3/README.md) | [sase-zu.3](sase-zu.3.md) | 0 |
