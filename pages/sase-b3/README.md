...
| [sase-b3.9](sase-b3.9.md) | Docs, core floor bump, and end-to-end verification | ✓ closed | small | 0 | 0 |
...
flowchart TD
    ...
    n4["sase-b3.10.2: Real titles on editor payload rows [in_progress]"]
