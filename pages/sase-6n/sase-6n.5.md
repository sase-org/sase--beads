# Bead: sase-6n.5 — Epic migration to clans and the @epic tribe

[Bead Pages](../README.md) / [sase-6n](README.md) / sase-6n.5

**Status:** ✓ closed · **Resolution:** (unrecorded) · **Type:** phase
**Owner:** `bryanbugyi34@gmail.com` · **Assignee:** `sase-6n.5`
**Created:** 2026-07-17 21:35:14 UTC
...
'Phase epic-clan' section: rename the epic lander to <epic_id>.land in sase-core, flip the legacy cleanup direction, and emit %clan:<epic_id> plus %tribe:epic on every epic segment.
...
- **Depends on:** [sase-6n.3](sase-6n.3.md) ✓
- **Blocks:** [sase-6n.8](sase-6n.8.md) ✓
