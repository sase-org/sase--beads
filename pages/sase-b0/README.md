...
| [sase-b0.2](sase-b0.2.md) | Files list, kind icons, and off-thread loading | ◐ in_progress | medium | 1 | 0 |
| [sase-b0.3](sase-b0.3.md) | Files detail panel with reference, metadata, and liveness | ◐ in_progress | medium | 1 | 0 |
| [sase-b0.4](sase-b0.4.md) | Files filter bar, kind cycle, and in-memory filtering | ◐ in_progress | medium | 1 | 0 |
| [sase-b0.5](sase-b0.5.md) | Smart open, viewer hand-off, external open, and agent jump | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-b0.2: Files list, kind icons, and off-thread loading [in_progress]"]
    n3["sase-b0.3: Files detail panel with reference, metadata, and liveness [in_progress]"]
    n4["sase-b0.4: Files filter bar, kind cycle, and in-memory filtering [in_progress]"]
    n5["sase-b0.5: Smart open, viewer hand-off, external open, and agent jump [in_progress]"]
...
| [bbugyi200.athena.sase-b0.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-b0.2/README.md) | [sase-b0.2](sase-b0.2.md) | 0 |
...
| [bbugyi200.athena.sase-b0.4](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-b0.4/README.md) | [sase-b0.4](sase-b0.4.md) | 0 |
