# Bead: sase-t8.1 — Generalize fork source resolution and history rendering

[Bead Pages](../README.md) / [sase-t8](README.md) / sase-t8.1

**Status:** ✓ closed · **Resolution:** done · **Type:** ↳ phase
**Owner:** `bryanbugyi34@gmail.com` · **Created by:** [bbugyi200.athena.0cz.f1](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.0cz.f1.md) · **Assignee:** `sase-t8.1` · **Size:** medium
**Created:** 2026-08-24 18:28:18 EDT · **Closed:** 2026-08-24 19:19:55 EDT
**Plan:** [202608/fork\_every\_shell.md](https://github.com/sase-org/sase--plans/blob/main/202608/fork_every_shell.md)

## Description

shell-history: resolve terminal agent and proc shells into typed, intuitive history, including mixed families and groups.
