...
| [sase-s5.2](sase-s5.2.md) | Restrict research Highlights generation to committed report events | ◐ in_progress | small | 2026-08-22 | 1 | 0 |
| [sase-s5.3](sase-s5.3.md) | Verify one canonical Highlights output across the coordinated repositories | ◐ in_progress | small | 2026-08-22 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-s5.2: Restrict research Highlights generation to committed report events [in_progress]"]
    n3["sase-s5.3: Verify one canonical Highlights output across the coordinated repositories [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n1 -.-> n2
...
| [bbugyi200.athena.sase-s5.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-s5.2/README.md) | [sase-s5.2](sase-s5.2.md) | 0 |
| [bbugyi200.athena.sase-s5.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-s5.3/README.md) | [sase-s5.3](sase-s5.3.md) | 0 |
