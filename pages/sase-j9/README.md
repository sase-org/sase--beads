...
| [sase-j9.2](sase-j9.2.md) | Give \`H\` a hinted fold collapse on a selected tribe panel | ◐ in_progress | medium | 2026-08-10 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-j9.2: Give `H` a hinted fold collapse on a selected tribe panel [in_progress]"]
    n0 --> n1
    n0 --> n2
    n1 -.-> n2
```
...
| [bbugyi200.athena.sase-j9.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-j9.2/README.md) | [sase-j9.2](sase-j9.2.md) | 0 |
