...
| [sase-i9.2](sase-i9.2.md) | Build the Rust core and LSP in one feature-unified cargo invocation | ◐ in_progress | medium | 2026-08-09 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-i9.2: Build the Rust core and LSP in one feature-unified cargo invocation [in_progress]"]
