...
| [sase-rd.5](sase-rd.5.md) | Panel CRUD, prompt entry, and release polish | ✓ closed | medium | 2026-08-20 | 1 | 1 |
...
flowchart TD
    ...
    n5["sase-rd.5: Panel CRUD, prompt entry, and release polish [closed]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
