...
|---|---|---|---|---:|---:|
| [sase-3s.1](sase-3s.1.md) | Phase 1 - Core Index Visibility And Reconciliation | ✓ closed | small | 0 | 1 |
| [sase-3s.2](sase-3s.2.md) | Phase 2 - Python Lifecycle Hooks | ✓ closed | small | 0 | 2 |
...
| [sase-3s.5](sase-3s.5.md) | Phase 5 - Loader/Performance Guardrails | ✓ closed | small | 0 | 2 |
