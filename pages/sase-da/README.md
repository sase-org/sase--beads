...
|---|---|---|---|---:|---:|
| [sase-da.1](sase-da.1.md) | Fair, configurable store-lock waits in sase-core | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-da.1: Fair, configurable store-lock waits in sase-core [in_progress]"]
