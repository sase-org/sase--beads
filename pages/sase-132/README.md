...
|---|---|---|---|---|---:|---:|
| [sase-132.1](sase-132.1.md) | Controlled baselines and startup observability gaps | ◐ in_progress | medium | 2026-09-18 | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-132.1: Controlled baselines and startup observability gaps [in_progress]"]
