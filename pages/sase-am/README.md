...
|---|---|---|---|---:|---:|
| [sase-am.1](sase-am.1.md) | Restore completed-run signal and unbreak lint | ✓ closed | small | 1 | 0 |
| [sase-am.2](sase-am.2.md) | Build the Rust core once per run | ◐ in_progress | medium | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-am.2: Build the Rust core once per run [in_progress]"]
