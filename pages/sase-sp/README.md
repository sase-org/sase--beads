...
|---|---|---|---|---|---:|---:|
| [sase-sp.1](sase-sp.1.md) | Typed deferral and a non-failing refusal policy in Rust core | ◐ in_progress | medium | 2026-08-24 | 1 | 1 |
...
flowchart TD
    ...
    n1["sase-sp.1: Typed deferral and a non-failing refusal policy in Rust core [in_progress]"]
