...
| [sase-18z.2](sase-18z.2.md) | Render note previews in the Context card | ◐ in_progress | medium | 2026-09-25 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-18z.2: Render note previews in the Context card [in_progress]"]
    n0 --> n1
    n0 --> n2
    n1 -.-> n2
```
...
| [bbugyi200.athena.sase-18z.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-18z.2/README.md) | [sase-18z.2](sase-18z.2.md) | 0 |
