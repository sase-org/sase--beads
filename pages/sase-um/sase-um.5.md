# Bead: sase-um.5 — Drive the master gate green
...
green: use the new per-commit signal to attribute and fix every failure the gate reports until master is durably green, filing task beads for flakes rather than muting them.
