...
| [sase-um.2](sase-um.2.md) | ci\_watch gating allowlist, heavy-lane freshness, and merge strategy | ◐ in_progress | large | 2026-08-26 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-um.2: ci_watch gating allowlist, heavy-lane freshness, and merge strategy [in_progress]"]
