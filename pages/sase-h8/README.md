...
flowchart TD
    ...
    n7["sase-h8.10.5: Finish the verified residue and land epic sase-h8.10 [closed]"]
    ...
    n10["sase-h8.10.5.3: Verify, close sase-h8.10, and complete its plan [closed]"]
