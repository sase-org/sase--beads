...
| [sase-n7.2](sase-n7.2.md) | Kill the N+1 proc-store reads | ◐ in_progress | medium | 2026-08-16 | 1 | 0 |
| [sase-n7.3](sase-n7.3.md) | Stop the O(archive) index query | ◐ in_progress | medium | 2026-08-16 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-n7.2: Kill the N+1 proc-store reads [in_progress]"]
    n3["sase-n7.3: Stop the O(archive) index query [in_progress]"]
