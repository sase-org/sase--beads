...
flowchart TD
    ...
    n6["sase-k0.4.2: Verify and close epic sase-k0 [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
...
| [bbugyi200.athena.sase-k0.4.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-k0.4.2/README.md) | [sase-k0.4.2](sase-k0.4.2.md) | 0 |
