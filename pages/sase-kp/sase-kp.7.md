# Bead: sase-kp.7 — Monitor rows in agent lists and family rosters
...
tui-rows: render monitor members in the Agents tab, family roster, and integration agent lists with their own glyph, phase label, live runtime, and status.

## Notes

[2026-08-12T23:46:47Z · sase-kp.7] PROPOSED FOLLOW-UP: classify legacy changespec tokens in validate_sase_core_rs terminology audit - just check fails patch/stitch terminology on tools/validate_sase_core_rs and tests/test_validate_sase_core_rs_tool.py
