# Bead: sase-6p.5 — Mobile wire and gateway migration

[Bead Pages](../README.md) / [sase-6p](README.md) / sase-6p.5

**Status:** ✓ closed · **Resolution:** (unrecorded) · **Type:** phase
**Owner:** `bryanbugyi34@gmail.com` · **Assignee:** `sase-6p.5`
**Created:** 2026-07-17 23:41:20 UTC · **Closed:** 2026-07-18 10:56:03 UTC
**Plan:** [202607/gate\_option\_queries.md](https://github.com/sase-org/sase--plans/blob/main/202607/gate_option_queries.md)

## Description

'Mobile wire and gateway migration' section: replace the per-kind mobile choice enums in sase-core with the generic gate branch wire, accept selected-option submissions, and update contract fixtures and docs/mobile_gateway.md.
...
- **Depends on:** [sase-6p.3](sase-6p.3.md) ✓
- **Blocks:** [sase-6p.8](sase-6p.8.md) ✓
