# Bead: sase-m9.1 — Sase agent and shell taxonomy
...
shell-taxonomy: plan and land the behavior-preserving terminology migration, glossary model, compatibility aliases, CLI language, and generated memory surfaces.
