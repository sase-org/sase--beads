...
| [sase-112.2](sase-112.2.md) | Plan-header semantic conflict resolver | ✓ closed | medium | 2026-09-14 | 1 | 1 |
...
flowchart TD
    ...
    n2["sase-112.2: Plan-header semantic conflict resolver [closed]"]
