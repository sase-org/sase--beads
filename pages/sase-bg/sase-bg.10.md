# Bead: sase-bg.10 — Memory template, sase\_beads skill, and documentation
...
docs-memory-skill: append the user-authorized task-bead recommendation to the builtin memory template and regenerate via sase memory init, update the sase_beads generated-skill source, and document the type, status, gate, and chop in docs/beads.md and docs/notifications.md.
