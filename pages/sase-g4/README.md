...
| [sase-g4.2](sase-g4.2.md) | Report an invalid header block from \`sase plan links validate\` | ◐ in_progress | small | 2026-08-06 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-g4.2: Report an invalid header block from `sase plan links validate` [in_progress]"]
