# Bead: sase-8f.2 — %id(bead=...) runner lifecycle

[Bead Pages](../README.md) / [sase-8f](README.md) / sase-8f.2

**Status:** ✓ closed · **Resolution:** (unrecorded) · **Type:** phase
**Owner:** `bryanbugyi34@gmail.com` · **Assignee:** `sase-8f.2` · **Size:** medium
**Created:** 2026-07-20 19:48:34 UTC · **Closed:** 2026-07-20 21:03:13 UTC
**Plan:** [202607/jit\_bead\_claims.md](https://github.com/sase-org/sase--plans/blob/main/202607/jit_bead_claims.md)

## Description

'%id(bead=...) runner lifecycle' section: parse and preserve the new keyword, then claim after waits and workspace preparation but before model execution.
...
- **Depends on:** [sase-8f.1](sase-8f.1.md) ✓
- **Blocks:** [sase-8f.3](sase-8f.3.md) ✓
