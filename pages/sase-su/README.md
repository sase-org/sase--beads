...
|---|---|---|---|---|---:|---:|
| [sase-su.1](sase-su.1.md) | Provider-drain planning and execution engine | ◐ in_progress | medium | 2026-08-24 | 1 | 1 |
| [sase-su.2](sase-su.2.md) | sase agent drain command and durable operation | ◐ in_progress | medium | 2026-08-24 | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-su.1: Provider-drain planning and execution engine [in_progress]"]
    n2["sase-su.2: sase agent drain command and durable operation [in_progress]"]
...
| [bbugyi200.athena.sase-su.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-su.2/README.md) | [sase-su.2](sase-su.2.md) | 0 |
