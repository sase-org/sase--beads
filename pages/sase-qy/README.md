...
| [sase-qy.2](sase-qy.2.md) | Persistent query bar on Bead and File | ◐ in_progress | medium | 2026-08-19 | 1 | 0 |
| [sase-qy.3](sase-qy.3.md) | Persistent query bar on Plan and every document provider | ◐ in_progress | medium | 2026-08-19 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-qy.2: Persistent query bar on Bead and File [in_progress]"]
    n3["sase-qy.3: Persistent query bar on Plan and every document provider [in_progress]"]
...
| [bbugyi200.athena.sase-qy.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-qy.2/README.md) | [sase-qy.2](sase-qy.2.md) | 0 |
| [bbugyi200.athena.sase-qy.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-qy.3/README.md) | [sase-qy.3](sase-qy.3.md) | 0 |
