...
| [sase-kv.3](sase-kv.3.md) | Icons on Artifacts tab descriptors and in sidecar ref config | ✓ closed | medium | 2026-08-13 | 1 | 1 |
...
flowchart TD
    ...
    n3["sase-kv.3: Icons on Artifacts tab descriptors and in sidecar ref config [closed]"]
