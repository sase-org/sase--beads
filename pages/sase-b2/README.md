...
| [sase-b2.2](sase-b2.2.md) | Local resolution and reverse canonicalization | ◐ in_progress | medium | 0 | 0 |
| [sase-b2.3](sase-b2.3.md) | Editor surfaces for the new kinds | ◐ in_progress | small | 0 | 0 |
...
flowchart TD
    ...
    n2["sase-b2.2: Local resolution and reverse canonicalization [in_progress]"]
    n3["sase-b2.3: Editor surfaces for the new kinds [in_progress]"]
