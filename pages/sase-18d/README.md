...
|---|---|---|---|---|---:|---:|
| [sase-18d.1](sase-18d.1.md) | Rust cleanup wire for live runners and atomic dismissed index | ◐ in_progress | medium | 2026-09-24 | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-18d.1: Rust cleanup wire for live runners and atomic dismissed index [in_progress]"]
