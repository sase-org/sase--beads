...
| [sase-12w.2](sase-12w.2.md) | Detached sudo answer path and finalize proc | ◐ in_progress | large | 2026-09-18 | 1 | 0 |
| [sase-12w.3](sase-12w.3.md) | TUI handoff returns after authentication | ◐ in_progress | medium | 2026-09-18 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-12w.2: Detached sudo answer path and finalize proc [in_progress]"]
    n3["sase-12w.3: TUI handoff returns after authentication [in_progress]"]
...
| [bbugyi200.athena.sase-12w.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-12w.3/README.md) | [sase-12w.3](sase-12w.3.md) | 0 |
