...
|---|---|---|---|---|---:|---:|
| [sase-185.1](sase-185.1.md) | Pending launch lifecycle and detached relaunch waits | ◐ in_progress | medium | 2026-09-24 | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-185.1: Pending launch lifecycle and detached relaunch waits [in_progress]"]
