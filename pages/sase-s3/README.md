...
| [sase-s3.4](sase-s3.4.md) | Prefer the latest authoritative family plan everywhere | ◐ in_progress | small | 2026-08-22 | 1 | 0 |
...
flowchart TD
    ...
    n4["sase-s3.4: Prefer the latest authoritative family plan everywhere [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
