...
| [sase-ek.2](sase-ek.2.md) | The host labels each repository and proves both surfaces agree | ◐ in_progress | small | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-ek.2: The host labels each repository and proves both surfaces agree [in_progress]"]
...
| [bbugyi200.athena.sase-ek.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ek.2/README.md) | [sase-ek.2](sase-ek.2.md) | 0 |
