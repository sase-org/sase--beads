# Bead: sase-14n.6 — Settle the clan-collapse agent-row label weight

[Bead Pages](../README.md) / [sase-14n](README.md) / sase-14n.6

**Status:** ✓ closed · **Resolution:** done · **Type:** ↳ phase
**Owner:** `bryanbugyi34@gmail.com` · **Created by:** [bbugyi200.athena.0oe](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.0oe.md) · **Assignee:** `sase-14n.6` · **Size:** medium
**Created:** 2026-09-20 17:14:14 EDT · **Closed:** 2026-09-21 11:56:23 EDT
...
row_weight_golden: decide whether the tribeless DONE agent row lost its bold label or the golden is stale, then fix the renderer or refresh that one snapshot.
