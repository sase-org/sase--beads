...
flowchart TD
    ...
    n8["sase-19f.6.2: Render multiplier capacity and expose agent-list JSON [in_progress]"]
    n9["sase-19f.6.3: Accept and preserve multiplier capacity in wait and directive editors [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
...
| [bbugyi200.apollo.sase-19f.6.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.sase-19f.6.2/README.md) | [sase-19f.6.2](sase-19f.6.2.md) | 0 |
