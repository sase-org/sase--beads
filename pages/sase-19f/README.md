...
| [sase-19f.2](sase-19f.2.md) | Rust admission resolution, scan records, and fleet contract | ◐ in_progress | medium | 2026-09-25 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-19f.2: Rust admission resolution, scan records, and fleet contract [in_progress]"]
...
| [bbugyi200.apollo.sase-19f.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.sase-19f.2/README.md) | [sase-19f.2](sase-19f.2.md) | 0 |
