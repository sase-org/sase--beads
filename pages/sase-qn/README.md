...
| [sase-qn.3](sase-qn.3.md) | Catalog fetch past GitHub search's 1000-result cap | ◐ in_progress | medium | 2026-08-18 | 1 | 0 |
...
flowchart TD
    ...
    n3["sase-qn.3: Catalog fetch past GitHub search's 1000-result cap [in_progress]"]
