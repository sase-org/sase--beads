...
|---|---|---|---|---:|---:|
| [sase-4x.1](sase-4x.1.md) | Phase 1 - Rust core: plan model + discovery (read layer) | ✓ closed | small | 1 | 1 |
| [sase-4x.2](sase-4x.2.md) | Phase 2 - Rust core: search + filters + ranking | ✓ closed | small | 1 | 1 |
| [sase-4x.3](sase-4x.3.md) | Phase 3 - PyO3 binding + Python facade + parity | ✓ closed | small | 1 | 2 |
