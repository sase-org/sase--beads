...
| [sase-ns.4](sase-ns.4.md) | File-panel assertions against the scroll-anchor seam | ✓ closed | small | 2026-08-16 | 1 | 0 |
...
flowchart TD
    ...
    n5["sase-ns.5: Models-panel jump PNG snapshot seam [in_progress]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
...
| [bbugyi200.athena.sase-ns.4](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ns.4/README.md) | [sase-ns.4](sase-ns.4.md) | 0 |
