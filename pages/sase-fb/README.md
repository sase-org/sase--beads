...
|---|---|---|---|---:|---:|
| [sase-fb.1](sase-fb.1.md) | Make every bead-store mutation publication-verified before the CLI reports success | ✓ closed | medium | 1 | 1 |
...
flowchart TD
    ...
    n1["sase-fb.1: Make every bead-store mutation publication-verified before the CLI reports success [closed]"]
