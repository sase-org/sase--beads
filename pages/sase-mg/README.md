...
| [sase-mg.2](sase-mg.2.md) | Replace current-agent list with show and build historical list | ◐ in_progress | medium | 2026-08-15 | 1 | 0 |
| [sase-mg.3](sase-mg.3.md) | Add the variable selector language and get command | ◐ in_progress | medium | 2026-08-15 | 1 | 0 |
...
flowchart TD
    ...
    n2["sase-mg.2: Replace current-agent list with show and build historical list [in_progress]"]
    n3["sase-mg.3: Add the variable selector language and get command [in_progress]"]
...
| [bbugyi200.athena.sase-mg.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-mg.2/README.md) | [sase-mg.2](sase-mg.2.md) | 0 |
| [bbugyi200.athena.sase-mg.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-mg.3/README.md) | [sase-mg.3](sase-mg.3.md) | 0 |
