...
|---|---|---|---|---|---:|---:|
| [sase-ij.1](sase-ij.1.md) | Derive the telemetry smoke test's expected minimum from pyproject | ◐ in_progress | small | 2026-08-09 | 1 | 0 |
| [sase-ij.2](sase-ij.2.md) | Build the window ratchet tool | ◐ in_progress | medium | 2026-08-09 | 1 | 0 |
| [sase-ij.3](sase-ij.3.md) | Enforce the published floor on the release branch and at publish time | ◐ in_progress | medium | 2026-08-09 | 1 | 0 |
...
| [sase-ij.8](sase-ij.8.md) | Merge sase-core release PRs from the release-plz workflow | ◐ in_progress | small | 2026-08-09 | 1 | 1 |
...
flowchart TD
    ...
    n1["sase-ij.1: Derive the telemetry smoke test's expected minimum from pyproject [in_progress]"]
    n2["sase-ij.2: Build the window ratchet tool [in_progress]"]
    n3["sase-ij.3: Enforce the published floor on the release branch and at publish time [in_progress]"]
...
| [bbugyi200.athena.sase-ij.8](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ij.8/README.md) | [sase-ij.8](sase-ij.8.md) | 1 |
