...
flowchart TD
    ...
    n3["sase-lb.1.2: Authoritative workspace-directory to workspace-number lookup [in_progress]"]
    n4["sase-lb.1.3: A monitor holds the claim on the workspace it runs in [in_progress]"]
    ...
    n7["sase-lb.1.6: The commit finalizer stops attributing pre-existing dirt to the agent [in_progress]"]
...
| [bbugyi200.athena.sase-lb.1.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-lb.1.2/README.md) | [sase-lb.1.2](sase-lb.1.2.md) | 0 |
...
| [bbugyi200.athena.sase-lb.1.6](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-lb.1.6/README.md) | [sase-lb.1.6](sase-lb.1.6.md) | 0 |
