...
| [sase-hb.3](sase-hb.3.md) | Catalog, authoring, completion, and documentation updates | ✓ closed | medium | 2026-08-07 | 1 | 1 |
| [sase-hb.4](sase-hb.4.md) | Enabled-project and chezmoi source migration | ✓ closed | small | 2026-08-07 | 1 | 1 |
| [sase-hb.5](sase-hb.5.md) | Cross-repository validation and canonical deployment | ✓ closed | small | 2026-08-07 | 1 | 1 |
...
flowchart TD
    ...
    n3["sase-hb.3: Catalog, authoring, completion, and documentation updates [closed]"]
    n4["sase-hb.4: Enabled-project and chezmoi source migration [closed]"]
    n5["sase-hb.5: Cross-repository validation and canonical deployment [closed]"]
    n0 --> n1
    n0 --> n2
    n0 --> n3
    n0 --> n4
