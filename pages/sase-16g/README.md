...
|---|---|---|---|---|---:|---:|
| [sase-16g.1](sase-16g.1.md) | Core restart, request, and config-layer semantics | ◐ in_progress | medium | 2026-09-22 | 1 | 0 |
| [sase-16g.2](sase-16g.2.md) | Restart is a confirmed transition | ◐ in_progress | medium | 2026-09-22 | 1 | 0 |
...
flowchart TD
    ...
    n1["sase-16g.1: Core restart, request, and config-layer semantics [in_progress]"]
    n2["sase-16g.2: Restart is a confirmed transition [in_progress]"]
...
| [bbugyi200.athena.sase-16g.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-16g.2/README.md) | [sase-16g.2](sase-16g.2.md) | 0 |
