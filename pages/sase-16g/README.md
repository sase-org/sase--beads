...
| [sase-16g.3](sase-16g.3.md) | Last-known-good config keeps the host supervising | ✓ closed | medium | 2026-09-22 | 1 | 1 |
| [sase-16g.4](sase-16g.4.md) | The host honors give\_up and says so | ✓ closed | medium | 2026-09-22 | 1 | 1 |
| [sase-16g.5](sase-16g.5.md) | The CLI and the Services tab show the real failure states | ◐ in_progress | medium | 2026-09-22 | 1 | 1 |
...
flowchart TD
    ...
    n3["sase-16g.3: Last-known-good config keeps the host supervising [closed]"]
    n4["sase-16g.4: The host honors give_up and says so [closed]"]
...
| --- | --- | --- | ---: |
| read-by | [agent:sase-16g.2][1] | Need epic scope for phase work | 1 |
