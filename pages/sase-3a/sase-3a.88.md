# Bead: sase-3a.88 — Remediate pyvision symbol: token\_to\_wire

[Bead Pages](../README.md) / [sase-3a](README.md) / sase-3a.88

**Status:** ✓ closed · **Resolution:** (unrecorded) · **Type:** phase
**Owner:** `bryanbugyi34@gmail.com`
**Created:** 2026-05-13 02:19:10 UTC
...
Converted token_to_wire to private _token_to_wire and updated tests and fixtures; removed --epic-symbol 'sase-3a(token_to_wire)' from Justfile. Ran just pyvision; remaining failures are unrelated private-symbol violations in other modules.

## Dependencies

- **Depends on:** [sase-3a.85](sase-3a.85.md) ✓
