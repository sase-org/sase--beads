# Bead: sase-3a.72 — Remediate pyvision symbol: query\_expr\_to\_wire

[Bead Pages](../README.md) / [sase-3a](README.md) / sase-3a.72

**Status:** ✓ closed · **Resolution:** (unrecorded) · **Type:** phase
**Owner:** `bryanbugyi34@gmail.com`
**Created:** 2026-05-13 02:16:59 UTC
...
Privatized query_expr_to_wire as _query_expr_to_wire; updated recursive calls and tests in test_core_query_golden_wire.py; removed Justfile epic-symbol entry; 
┌───────────────────────────────────────────────────────┐
...
- **Depends on:** [sase-3a.69](sase-3a.69.md) ✓
- **Blocks:** [sase-3a.75](sase-3a.75.md) ✓
