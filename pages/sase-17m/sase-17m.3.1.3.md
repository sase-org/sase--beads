...
**Owner:** `bryanbugyi34@gmail.com` · **Created by:** [bbugyi200.athena.sase-17m.3](https://github.com/sase-org/sase--agents/blob/main/sessions/bbugyi200.athena.sase-17m.3.md) · **Assignee:** `sase-17m.3.1.3` · **Size:** medium
...
| --- | --- | --- | ---: |
| read-by | [agent:sase-17m.3.1.3][1] | Need the phase scope and design file | 1 |
| read-by | [agent:sase-17m.3.1.land][2] | Need the child scope and notes | 1 |

[1]: https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-17m.3.1.3/README.md
